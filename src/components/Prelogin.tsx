      ...
      <div className="relative flex-grow overflow-hidden mx-4 sm:mx-6 md:mx-8 lg:mx-10 h-[calc(100vh-8rem)]">
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="relative">
            <h1 className="text-[10vw] font-bold text-white font-alatsi px-[5px] pt-4 text-center leading-none whitespace-nowrap overflow-hidden">
              REUNITE . HOPE . FIND
            </h1>
            <p className="text-gray-600 font-montserrat text-left mt-2 px-4 pl-10 text-sm sm:text-base md:text-lg lg:text-lg w-2/5">
          ...
          <div className="flex-1 relative mt-[-150px] flex justify-center">
